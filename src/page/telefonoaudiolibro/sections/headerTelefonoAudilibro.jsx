    ...
    return (
        <>       
            <section className="headerDescription flex flex-col gap-y-12">
                ...
                <div>
                    <button className="mt-0 mb-4 bg-lime-300 rounded-2xl border-1 border-black py-2 px-3.5 font-bold md:text-xl hover:scale-105 transition-transform duration-200"> 
                        ENVIAR SOLICITUD 
                    </button>
            ...
            <img src="./media/header/telf07.webp" alt="telefonoaudiolibro.es"/>
        </>
    )
}
