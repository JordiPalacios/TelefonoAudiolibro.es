    ...
    return (
        <>
            ...
            <div className="componentAnimation relative flex flex-row items-end justify-center w-full h-40 md:h-80 mt-25 mb-10 md:my-15">                
                <p className="italic font-bold text-lg md:text-xl lg:text-2xl tracking-tighter leading-tight absolute z-20 -ml-80 md:-ml-135 mb-50 md:mb-60 w-20 text-center">
                    Espejo decorativo
                </p>
                <ArrowDownRight className="w-8 h-8 absolute z-20 -ml-80 md:-ml-135 mb-40 md:mb-50 text-pink-500" />
                <img 
                ...
                <p className="italic font-bold text-lg md:text-xl lg:text-2xl tracking-tighter leading-tight absolute z-20 -mr-80 md:-mr-115 mb-35 md:mb-50 w-20 text-center">
                    Teléfono audiolibro
                </p>
                <ArrowDownLeft className="w-8 h-8 -scale-x-100 absolute z-20 -mr-80 md:-mr-115 mb-25 md:mb-40 text-pink-500" />
