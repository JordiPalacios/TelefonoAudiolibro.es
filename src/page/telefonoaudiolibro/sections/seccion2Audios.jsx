...
export const Seccion2Audios = () => {
    ...
    return (
        <>      
            ...
            className="componentAnimation block 2xl:px-5 max-w-40 md:max-w-60 lg:max-w-xs object-cover absolute top-0 -left-7.5 md:-left-10 lg:-left-1/24 xl:-left-10 2xl:left-100"
            />
            ...
            <div className="flex flex-col items-center justify-center text-cente mt-10 z-10">
                <span className="tinos font-extrabold text-5xl md:text-7xl tracking-tighter"> guarda </span>
                <p className="tinos text-4xl md:text-6xl rotate-2 r max-w-75 md:max-w-xl lg:max-w-5xl tracking-tighter">
                    la voz
                </p>
                <p className="tinos font-extrabold text-5xl md:text-7xl tracking-tighter">
                    de tu <span className="title-accent font-extrabold text-pink-500/90">ABUELA</span>
                </p>
                <small className="tinos italic font-bold text-lg md:text-xl lg:text-2xl text-pink-700 mb-6 tracking-tighter">para siempre.</small>
