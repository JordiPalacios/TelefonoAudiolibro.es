...
export const PoliticaPrivacidad = () => {
    ...
    return (
    <>
        <Section as="main" id='politicaPrivacidad' className="mt-20 px-5">                                
            <h1 className="title-font text-3xl xl:text-5xl mb-5 tracking-tighter leading-tight font-extrabold underline decoration-3 underline-offset-2">Política de Privacidad</h1>
            <p className="text-start mb-5 text-lg 2xl:text-xl tracking-tighter leading-tight">
                El sitio web Telefonoaudiolibro.es es propiedad de Telefonoaudiolibro.es, que es un controlador de datos de tus datos personales.
                <br />
                <br />
                Hemos adoptado esta Politica Privacidad, que determina cómo procesamos la información recopilada por Telefonoaudiolibro.es, que también proporciona las razones por las que debemos recopilar ciertos datos personales sobre ti. Por lo tanto, debes leer esta Política de privacidad antes de usar el sitio web de Telefonoaudiolibro.es.
                <br />
                <br />
                ...
                Derechos en relación con la toma de decisiones automatizada y la elaboración de perfiles. <br />
                ...
                <br />
                Si deseas comunicarte con nosotros para comprender más sobre esta Politica Privacidad o deseas comunicarte con nosotros en relación con cualquier asunto sobre los derechos individuales y tu información personal, puedes enviarnos un correo electrónico a <span style={{ color : 'var(--accent)'}}>contacto@telefonoaudiolibro.es</span>.
